  ...
  constructor(props) {
   ...
   forgetusername () {
     ...
     const email_id = document.getElementById('email_id').value;
         axios.post(axios.defaults.baseURL + '/api/forget_username', {
           email_id:email_id
       })
  ...
  return (
    ...
    <div className={styles.form}>
      ...
      <form>
        ...
        <Input size='large' id='email_id' onPressEnter={this.handleOk} placeholder='Enter E-mail' />
        </FormItem>

        <Row>
          <Button type='primary' size='large' onClick={this.forgetusername} >
            Submit
          </Button><br /><br />
