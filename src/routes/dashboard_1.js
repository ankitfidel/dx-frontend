...
import NumberCardLines from '../components/dashboard/numberCard_lines'
...
function Dashboard({dashboard, dispatch}) {
  ...
  const numberCardsLines = numbers_3.map((item, key) =>
  <Col key={key} lg={6} sm={12}>
    <NumberCardLines {...item} />
  </Col>
  )
  return (
