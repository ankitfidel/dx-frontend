...
import style from '../components/skin.less'
     ...
     var myDate = new Date();
       ...
       //   const content2 =  response.data.result.theme.content_2;
         ...
         if(response.data.status == false){
           ...
           if(response.data.result.user_role_id==1){
               this.setState({errormsg:"Admin cannot access this dashbard"})
       }else{
...
document.title = "Login";
 ...
 <div className={styles.shake} style={{'textAlign': 'center','marginTop': '10px', 'textTransform' : 'capitalize','marginBottom': '20px', 'color': 'red','fontSize': '12px'}}> { this.state.errormsg } </div>
